...
var FormComment = function (_React$Component) {
  ...
  function FormComment(props) {
    ...
    var _this = _possibleConstructorReturn(this, (FormComment.__proto__ || Object.getPrototypeOf(FormComment)).call(this, props));
  ...
  _createClass(FormComment, [{
    ...
    value: function getProps() {
      ...
      var props = keys.reduce(function (props, key) {
        props['data-' + key.toLowerCase()] = _this2.props[key];
        return props;
      }, {});
      return props;
    }
    ...
    value: function validateField(fieldName, value) {
      ...
      switch (fieldName) {
        ...
        case 'message':
          ...
          this.setState(_defineProperty({ messageValid: messageValid }, 'messageValid', messageValid));
          break;
        default:
          break;
      }
    ...
    value: function handleSubmit(event) {
      ...
      if (errors['email'].length == 0 && errors['message'].length == 0) {
        var params = this.getProps();
        var headers = {
          'Content-Type': "application/vnd.api+json",
          'Accept': "application/vnd.api+json"
        };
        var comment = this.CreateData(params);
    ...
    key: 'CreateData',
    value: function CreateData(params) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'drupal-form-comments' },
        React.createElement(
          'form',
          { className: 'drupal-form-comment', onSubmit: this.handleSubmit },
          React.createElement(
            'div',
...
var _FormComment = __webpack_require__(7);
...
var Comment = function (_React$Component) {
  ...
  function Comment(props) {
    ...
    _this.onHideChild = _this.onHideChild.bind(_this);
    _this.onAddChild = _this.onAddChild.bind(_this);
  ...
  _createClass(Comment, [{
    ...
    key: 'onAddChild',
    value: function onAddChild(event) {
      event.preventDefault();
      this.setState({
        replyform: true
      });
    ...
    key: 'onHideChild',
    value: function onHideChild(event) {
      event.preventDefault();
      this.setState({
        replyform: false
      });
    ...
    value: function render() {
      var params = this.getProps();
      var entry = params['data-data_comment'];
      var config = params['data-params']['data-params'];
      var reply = "";
      var button = React.createElement(
        'button',
        { type: 'button', className: 'reply-button', onClick: this.onAddChild },
        'Reply'
      );
      if (this.state.replyform) {
        var reply = React.createElement(_FormComment2.default, { params: config, parent: entry.id, onCommentSubmit: this.handleCommentSubmit });
        var button = React.createElement(
          'button',
          { type: 'button', className: 'reply-button', onClick: this.onHideChild },
          'Reply'
        );
      }
      var FormatDate = function FormatDate(_ref) {
        var createdDate = _ref.createdDate;
        return React.createElement(_reactIntl.FormattedDate, {
          value: createdDate,
          year: 'numeric',
          day: 'numeric',
          month: 'numeric',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              { locale: 'en' },
              React.createElement(FormatDate, { createdDate: new Date(entry.attributes.created) })
            )
          )
        ),
        React.createElement(
          ...
          React.createElement('div', { dangerouslySetInnerHTML: { __html: entry.attributes.comment_body.value } }),
          button,
          reply
        )
      );
...
var IntlMessageFormat = __webpack_require__(47)['default'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locale_data_index_js__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_intl_messageformat__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_intl_relativeformat__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_invariant__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_intl_format_cache__ = __webpack_require__(40);
/*
...
function formatMessage(config, state) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    __WEBPACK_IMPORTED_MODULE_6_invariant___default()(!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_react__["isValidElement"])(config), '[React Intl] Don\'t pass React elements to ' + 'formatMessage(), pass `.props`.');
  }
...
var IntlProvider = function (_Component) {
  ...
  function IntlProvider(props) {
    ...
    var _ref = intlContext || {},
      ...
      getDateTimeFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(Intl.DateTimeFormat),
      getNumberFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(Intl.NumberFormat),
      getMessageFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_1_intl_messageformat___default.a),
      getRelativeFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_2_intl_relativeformat___default.a),
      getPluralFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(IntlPluralFormat)
    } : _ref$formatters;
...
var defaultFormatMessage = function defaultFormatMessage(descriptor, values) {
  ...
  return formatMessage({}, { getMessageFormat: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_intl_format_cache__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_1_intl_messageformat___default.a) }, descriptor, values);
};
...
var _ChildComment = __webpack_require__(35);

var _ChildComment2 = _interopRequireDefault(_ChildComment);
...
var ListComment = function (_React$Component) {
  ...
  _createClass(ListComment, [{
    ...
    value: function componentDidMount() {
      ...
      var params = this.getProps();
      var sort = "&sort[sort-created][path]=created&sort[sort-created][direction]=DESC";
      axios({
        method: "GET",
    ...
    value: function getProps() {
      ...
      var keys = Object.keys(this.props);
      var props = keys.reduce(function (props, key) {
        props['data-' + key.toLowerCase()] = _this5.props[key];
        return props;
      }, {});
      return props;
    }
    ...
    value: function render() {
      ...
      if (this.state.comments && this.state.comments.length > 0) {
        ...
        var comments = data.map(function (entry, index) {
          var parent = "";
          var child = "";
          if (entry.relationships.pid.data == null) {
            var parent = React.createElement(_Comment2.default, { params: params, data_comment: entry, refreshlist: _this6.refreshlist });
          }
          var child = React.createElement(_ChildComment2.default, { params: params, url_api: params['data-params']['data-url_api'], pid: entry.id });
      ...
      return React.createElement(
        'div',
        { className: 'drupal-list-comments' },
        React.createElement(
          'div',
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/dist/cjs.js!./comment.css", function() {
		var newContent = require("!!../node_modules/css-loader/dist/cjs.js!./comment.css");
...
var ChildComment = function (_React$Component) {
  _inherits(ChildComment, _React$Component);

  function ChildComment(props) {
    _classCallCheck(this, ChildComment);

    // Set some state
    var _this = _possibleConstructorReturn(this, (ChildComment.__proto__ || Object.getPrototypeOf(ChildComment)).call(this, props));
  ...
  _createClass(ChildComment, [{
    ...
    value: function getProps() {
      ...
      var keys = Object.keys(this.props);
      var props = keys.reduce(function (props, key) {
        props['data-' + key.toLowerCase()] = _this3.props[key];
        return props;
      }, {});
      return props;
    }
    ...
    value: function render() {
      ...
      if (this.state.childcomments && this.state.childcomments.length > 0) {
        var data = this.state.childcomments;
        var comments = data.map(function (entry, index) {
          return React.createElement(_Comment2.default, { params: params, key: index, data_comment: entry });
        });
        var title = "Comments";
      }
...
var _ListComment = __webpack_require__(17);
...
var DrupalComments = function (_React$Component) {
  _inherits(DrupalComments, _React$Component);

  function DrupalComments(props) {
    _classCallCheck(this, DrupalComments);

    // Bind the this context to the handler function
    var _this = _possibleConstructorReturn(this, (DrupalComments.__proto__ || Object.getPrototypeOf(DrupalComments)).call(this, props));
  ...
  _createClass(DrupalComments, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'block-drupal-comments' },
        React.createElement(
          'h2',
          null,
          'Comments'
        ),
        React.createElement(_FormComment2.default, { params: params, onCommentSubmit: this.handleCommentSubmit }),
        React.createElement(_ListComment2.default, { params: params, refresh: this.state.refresh })
      );
    }
  }]);
...
exports.default = DrupalComments;
...
// Module
exports.push([module.i, ".block-drupal-comments{\n\tpadding-top: 25px;\n}\n\t.drupal-form-comments {\n\t\tpadding-bottom: 30px;\n\t}\n\t\t.drupal-form-comment .field-input {\n\t\t\tpadding-bottom: 0.75rem;\n\t\t}\n\n\t\t\t.drupal-form-comment input, .drupal-form-comment textarea {\n\t\t\t\tdisplay: block;\n\t\t\t    width: 100%;\n\t\t\t    height: calc(1.5em + .75rem + 2px);\n\t\t\t    padding: .375rem .75rem;\n\t\t\t    font-size: 1rem;\n\t\t\t    font-weight: 400;\n\t\t\t    line-height: 1.5;\n\t\t\t    color: #495057;\n\t\t\t    background-color: #fff;\n\t\t\t    background-clip: padding-box;\n\t\t\t    border: 1px solid #ced4da;\n\t\t\t    border-radius: .25rem;\n\t\t\t    transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;\n\t\t\t}\n\n\t\t\t.drupal-form-comment textarea {\n\t\t\t\theight: auto;\n\t\t\t}\n\n\t\t.drupal-form-comment button{\n\t\t\tdisplay: inline-block;\n\t\t    font-weight: bold;\n\t\t    color: #212529;\n\t\t    text-align: center;\n\t\t    vertical-align: middle;\n\t\t    -webkit-user-select: none;\n\t\t    -moz-user-select: none;\n\t\t    -ms-user-select: none;\n\t\t    user-select: none;\n\t\t    background-color: transparent;\n\t\t    border: 1px solid transparent;\n\t\t    padding: .375rem .75rem;\n\t\t    font-size: 1.25rem;\n\t\t    line-height: 1.5;\n\t\t    border-radius: .25rem;\n\t\t    color: #fff;\n\t\t    background-color: #663399;\n\t\t    border-color: #663399;\n\t\t}\n\n\t\t.drupal-form-comment .error-message, .drupal-form-comment .error-email{\n\t\t\tborder: 1px solid red;\n\t\t}\n\n\n\t.drupal-list-comments .item-comment{\n\t\tdisplay: table;\n\t\tmargin-bottom: 19px;\n\t\tvertical-align: top;\n\t}\n\t\t.drupal-list-comments .comment__meta{\n\t\t\t\tpadding: 0 30px 0 0;\n\t\t\t    font-size: 1.071em;\n\t\t\t    display: block;\n\t\t}\n\n\t\t.drupal-list-comments .comment__content{\n\t\t\t\tpadding: 0 30px 0 0;\n\t\t\t    font-size: 1.071em;\n\t\t\t    position: relative;\n\t\t\t    display: table-cell;\n\t\t\t    width: 100%;\n\t\t\t    padding: 10px 25px 10px 25px;\n\t\t\t    vertical-align: top;\n\t\t\t    word-break: break-all;\n\t\t\t    border: 1px solid #d3d7d9;\n\t\t\t    font-size: 0.929em;\n\t\t\t    line-height: 1.6;\n\t\t}\n\n\t\t.drupal-list-comments .comment__content:before{\n\t\t\t\tposition: absolute;\n\t\t\t    top: 20px;\n\t\t\t    right: 100%;\n\t\t\t    content: \"\";\n\t\t\t    border-top: 20px solid transparent;\n\t\t\t    border-right: 20px solid #d3d7d9;\n\t\t\t    border-bottom: 20px solid transparent;\n\t\t}\n\n\t\t.drupal-list-comments .reply-button{\n\t\t\t\tbox-sizing: inherit;\n\t\t\t    color: #8a4baf;\n\t\t\t    font-size: 14px;\n\t\t\t    line-height: 17px;\n\t\t\t    text-decoration: none;\n\t\t\t    background: transparent;\n\t\t\t    border: 0;\n\t\t\t    padding-top: 10px;\n\t\t\t    cursor: pointer;\n\t\t\t    text-transform: capitalize;\n\t\t}\n\n\t\t.drupal-list-comments .child-comments{\n\t\t\tmargin-left: 40px;\n\t\t}", ""]);
...
var src$utils$$ = __webpack_require__(15), src$es5$$ = __webpack_require__(46), src$compiler$$ = __webpack_require__(43), intl$messageformat$parser$$ = __webpack_require__(41);
...
var src$core$$ = __webpack_require__(44), src$en$$ = __webpack_require__(45);
...
var IntlRelativeFormat = __webpack_require__(53)['default'];
...
/* jslint esnext: true */
var intl_messageformat_1 = __webpack_require__(14);
var diff_1 = __webpack_require__(50);
var es5_1 = __webpack_require__(52);
